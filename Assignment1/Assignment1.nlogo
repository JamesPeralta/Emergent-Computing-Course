breed [wasps wasp]
breed [bluemats bluemat]
breed [redmats redmat]
...
to search-for-material ;; wasps procedure
  ask wasps [
    let possiblemat one-of bluemats-here
    ...
    ;; convert neighbors list to material numbers
  ]
end
